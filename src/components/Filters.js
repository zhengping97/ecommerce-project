...
const Filters = () => {
  const { filters: { text, category, company, color, max_price, min_price, price, shipping }, updateFilters, clearFilters, all_products } = useFilterContext();
          ...
          <div className='form-control'>
            ...
            <div>
              {categories.map((c, index) => {
                return <button key={index} onClick={updateFilters} type='button' name='category'
            ...
            <div className='colors'>
              {colors.map((c, index) => {
                ...
                return <button key={index} name='color' style={{ background: c }}
                  className={`${color === c ? 'color-btn active' : 'color-btn'}`} data-color={c} onClick={updateFilters}>
